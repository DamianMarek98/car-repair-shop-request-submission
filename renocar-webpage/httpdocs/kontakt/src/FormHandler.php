...
class FormHandler
{
	...
	public function __construct()
	{
		...
		$this->mailer->Subject = "Wiadomość z renocar";

		$host = isset($_SERVER['SERVER_NAME'])?$_SERVER['SERVER_NAME']:'localhost';
        $from_email ='automat@renocar.pl';
   		$this->mailer->setFrom($from_email,'Automat',false);  
	...
	{
		$content = "Wiadomość ze strony renocar\nWysłane z IP: ".$_SERVER['REMOTE_ADDR']."\r\n------------------------------------------------------\n\n";
